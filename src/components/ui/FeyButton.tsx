    ...
    <button
      className={cn(
        ...
        isDark
          ...
          : "[box-shadow:inset_0_0_0_0.5px_rgba(203,213,225,1),inset_1px_1px_0_-0.5px_rgba(203,213,225,1),inset_-1px_-1px_0_-0.5px_rgba(203,213,225,1)]",
        ...
        // Hover shadows
        isDark
          ? "after:[box-shadow:inset_0_0_0_0.5px_rgba(255,255,255,0.2),inset_1px_1px_0_-0.5px_rgba(255,255,255,0.4),inset_-1px_-1px_0_-0.5px_rgba(255,255,255,0.4),0_0_3px_rgba(255,255,255,0.1)]"
          : "after:[box-shadow:inset_0_0_0_0.5px_rgba(203,213,225,1),inset_1px_1px_0_-0.5px_rgba(203,213,225,1),inset_-1px_-1px_0_-0.5px_rgba(203,213,225,1),0_0_3px_rgba(59,130,246,0.3)]",
